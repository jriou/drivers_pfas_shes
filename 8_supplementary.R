...
warning = FALSE,
fig.align = "center",
fig.width = 6.5,     # good width for A4/Letter in Word
fig.asp   = 0.618,   # golden-ish ratio; adjust as needed
out.width = "100%",
dev = "png"          # docx handles PNGs well
)
...
all_ = dplyr::bind_rows(uni_,mul_,mul2_)
...
asso = fn_302_table_regression_by_covariate2(cov_="age",coefs_=all_)
asso[[1]]
asso[[2]]

#' ### Sex

asso = fn_302_table_regression_by_covariate2(cov_="gender",coefs_=all_)
asso[[1]]
asso[[2]]

#' ### Foreign nationality

asso = fn_302_table_regression_by_covariate2(cov_="a1_foreign",coefs_=all_)
asso[[1]]
asso[[2]]

#' ### Education

asso = fn_302_table_regression_by_covariate2(cov_="a1_education_3classes",coefs_=all_)
asso[[1]]
asso[[2]]

#' ### Household monthly income

asso = fn_302_table_regression_by_covariate2(cov_="a1_household_monthly_income_3classes",coefs_=all_)
asso[[1]]
asso[[2]]

#' ### Study site

asso = fn_302_table_regression_by_covariate2(cov_="center_label",coefs_=all_)
asso[[1]]
asso[[2]]
...
#' ### Diet cluster
#' 
asso = fn_302_table_regression_by_covariate2(cov_="cluster",coefs_=all_)
asso[[1]]
asso[[2]]

#' ### Overall fish consumption
#' 
asso = fn_302_table_regression_by_covariate2(cov_="ex1_fish_freq",coefs_=all_)
asso[[1]]
asso[[2]]

#' ### Tuna (frequent consumption of)

asso = fn_302_table_regression_by_covariate2(cov_="ex1_tuna",coefs_=all_)
asso[[1]]
asso[[2]]

#' ###  Salmon (frequent consumption of)

asso = fn_302_table_regression_by_covariate2(cov_="ex1_salmon",coefs_=all_)
asso[[1]]
asso[[2]]

#' ### Pangasius (frequent consumption of)

asso = fn_302_table_regression_by_covariate2(cov_="ex1_pangasius",coefs_=all_)
asso[[1]]
asso[[2]]

#' ### Trout (frequent consumption of)

asso = fn_302_table_regression_by_covariate2(cov_="ex1_trout",coefs_=all_)
asso[[1]]
asso[[2]]

#' ### Shrimp (frequent consumption of)

asso = fn_302_table_regression_by_covariate2(cov_="ex1_shrimp",coefs_=all_)
asso[[1]]
asso[[2]]

#' ### Local fish from Swiss lakes (frequent consumption of)

asso = fn_302_table_regression_by_covariate2(cov_="ex1_swiss_fish",coefs_=all_)
asso[[1]]
asso[[2]]
...
asso = fn_302_table_regression_by_covariate2(cov_="ex1_veggie_vegan",coefs_=all_)
asso[[1]]
asso[[2]]

#' ###  Tap water

asso = fn_302_table_regression_by_covariate2(cov_="ex1_tapwater",coefs_=all_)
asso[[1]]
asso[[2]]

#' ###  Alcohol

asso = fn_302_table_regression_by_covariate2(cov_="ex1_alcool_weekly",coefs_=all_)
asso[[1]]
asso[[2]]

#' ###  Tobacco

asso = fn_302_table_regression_by_covariate2(cov_="ex1_cig",coefs_=all_)
asso[[1]]
asso[[2]]
...
asso = fn_302_table_regression_by_covariate2(cov_="ex2_skiwax",coefs_=all_)
asso[[1]]
asso[[2]]

#' ### Use of water-repellent spray

asso = fn_302_table_regression_by_covariate2(cov_="ex2_spray_imp",coefs_=all_)
asso[[1]]
asso[[2]]

#' ### Hot meals from disposable package (frequency)

asso = fn_302_table_regression_by_covariate2(cov_="ex1_hot_meals_package_freq",coefs_=all_)
asso[[1]]
asso[[2]]
...
asso = fn_302_table_regression_by_covariate2(cov_="ex1_residence_urban",coefs_=all_,cov_dataname="ex1_residence_urban")
asso[[1]]
asso[[2]]

#' ### Synthetic or natural carpet at home 

asso = fn_302_table_regression_by_covariate2(cov_="ex1_carpet",coefs_=all_)
asso[[1]]
asso[[2]]
...
asso = fn_302_table_regression_by_covariate2(cov_="ex1_bodylotion_freq",coefs_=all_)
asso[[1]]
asso[[2]]

#' ### Use of deodorant roll (frequency)

asso = fn_302_table_regression_by_covariate2(cov_="ex1_deo_roll_freq",coefs_=all_)
asso[[1]]
asso[[2]]

#' ### Use of deodorant spray (frequency)

asso = fn_302_table_regression_by_covariate2(cov_="ex1_deo_spray_freq",coefs_=all_)
asso[[1]]
asso[[2]]

#' ### Use of hair spray (frequency)

asso = fn_302_table_regression_by_covariate2(cov_="ex1_hairspray_freq",coefs_=all_)
asso[[1]]
asso[[2]]

#' ### Use of perfume (frequency)

asso = fn_302_table_regression_by_covariate2(cov_="ex1_perfume_freq",coefs_=all_)
asso[[1]]
asso[[2]]

#' ### Use of hand cream (frequency)

asso = fn_302_table_regression_by_covariate2(cov_="ex1_handcream_freq",coefs_=all_)
asso[[1]]
asso[[2]]
...
asso = fn_302_table_regression_by_covariate2(cov_="ex2_prof_smoke",coefs_=all_)
asso[[1]]
asso[[2]]

#' ### Exhaust gas

asso = fn_302_table_regression_by_covariate2(cov_="ex2_prof_exhaust_gas",coefs_=all_)
asso[[1]]
asso[[2]]

#' ### Solvent vapours

asso = fn_302_table_regression_by_covariate2(cov_="ex2_prof_solvent_vapours",coefs_=all_)
asso[[1]]
asso[[2]]

#' ### Cleaning agents

asso = fn_302_table_regression_by_covariate2(cov_="ex2_prof_cleaning_agents",coefs_=all_)
asso[[1]]
asso[[2]]

#' ### Dust

asso = fn_302_table_regression_by_covariate2(cov_="ex2_prof_dust",coefs_=all_)
asso[[1]]
asso[[2]]

#' ### Ski wax

asso = fn_302_table_regression_by_covariate2(cov_="ex2_prof_skiwax",coefs_=all_)
asso[[1]]
asso[[2]]

#' ### Impregnation sprays

asso = fn_302_table_regression_by_covariate2(cov_="ex2_prof_spray_imp",coefs_=all_)
asso[[1]]
asso[[2]]
